...
export default function MedicineSearch() {
  ...
  const API_URL = import.meta.env.VITE_FILTER_API_URL;
            ...
            <div className="flex gap-4">
              <div className="flex-1 relative">
                ...
                {showSuggestions && suggestions.length > 0 && (
                  <ul className="absolute bg-white border rounded-lg shadow-lg mt-2 w-full max-h-48 overflow-auto z-10">
                    {suggestions.map((suggestion, index) => (
                      <li
                        ...
                        onMouseDown={() => {
                          ...
                          setShowSuggestions(false);
                          searchMedicines(); // Optionally trigger search when a suggestion is clicked
                        }}
                      >
                        {suggestion}
                      </li>
